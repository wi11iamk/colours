...
Deficient eye hand coordination is often the sum of neuro-physiological disturbances and can be treated by strengthening the oculo-manual muscles. Therapy may also reinforce the neural pathways that sequence visual input with hand movement.
# Dependencies
# Install
# Usage
